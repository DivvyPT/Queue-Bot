...
// Join Text Queue
         ...
         if (args.length >= 1 && args[0]!=='') {
            ...
            //chat geral
            MessagingUtils.sendTempMessage("Para entrares na lista de espera tens de escrever !join com os dinos que podes levar para esta raid. Exemplo: !join tryos. Se conseguires fazer com qualquer um escreve !join todos.", channel, 20);
         }
// My Queues
