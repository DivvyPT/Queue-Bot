...
// Join Text Queue
         ...
         if (args.length >= 2) {
            ...
            //chat geral
            message.reply(`Para entrar na lista de espera tens de escrever o nome dos dinos que podes levar para esta raid./nExemplo: !join canal tryos. Se conseguires fazer com qualquer escreve !join canal todos.`);
         }
// My Queues
